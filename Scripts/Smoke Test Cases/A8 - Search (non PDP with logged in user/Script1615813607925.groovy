...
WebUI.sendKeys(findTestObject('HomePage/Search_area'), 'DE3G011')

WebUI.click(findTestObject('HomePage/Search_Button'))

WebUI.clearText(findTestObject('HomePage/Search_area'))

WebUI.sendKeys(findTestObject('HomePage/Search_area'), '2947')
